			...
			<!--VALUE FOR MONEY-->
				<div class="new-arrivals-w3agile">
					<div class="container">
						...
						<?php 
							$CategoryId=$this->encryption->encrypt('2');
							$CategoryId=str_replace(array('+', '/', '='), array('-', '_', '~'), $CategoryId); 

							$categoryname=$this->encryption->encrypt('VALUE FOR MONEY');
						...
						<div class="arrivals-grids">
							<?php foreach ($homevalueformoneys as $homevalueformoney): ?>
								<?php
										...
										$enc_username=$this->encryption->encrypt($homevalueformoney->Product_Id);
			...
			<!--PRE ORDER-->
				<div class="new-arrivals-w3agile">
					<div class="container">
						<!--<h2 class="tittle">VALUE FOR MONEY</h2>-->
						<?php 
							$CategoryId=$this->encryption->encrypt('3');
							$CategoryId=str_replace(array('+', '/', '='), array('-', '_', '~'), $CategoryId); 

							$categoryname=$this->encryption->encrypt('PRE ORDER');
							$categoryname=str_replace(array('+', '/', '='), array('-', '_', '~'), $categoryname);
						...
						<div class="arrivals-grids">
							<?php foreach ($homepreorders as $homepreorder): ?>
								<?php
										$this->load->library('encrypt');
										$enc_username=$this->encryption->encrypt($homepreorder->Product_Id);
										$enc_username=str_replace(array('+', '/', '='), array('-', '_', '~'), $enc_username);
								?>
							<div class="col-lg-13 col-md-3 arrival-grid simpleCart_shelfItem">
								<div class="grid-arr">
			...
			<!--NEW RELEASES-->
				<div class="new-arrivals-w3agile">
					<div class="container">
						<!--<h2 class="tittle">VALUE FOR MONEY</h2>-->
						<?php 
							$CategoryId=$this->encryption->encrypt('4');
							$CategoryId=str_replace(array('+', '/', '='), array('-', '_', '~'), $CategoryId);

							$categoryname=$this->encryption->encrypt('NEW RELEASES');
							$categoryname=str_replace(array('+', '/', '='), array('-', '_', '~'), $categoryname);
						...
						<div class="arrivals-grids">
							...
							<?php foreach ($homenewreleasess as $homenewreleases): ?>
								<?php
										$this->load->library('encrypt');
										$enc_username=$this->encryption->encrypt($homenewreleases->Product_Id);
										$enc_username=str_replace(array('+', '/', '='), array('-', '_', '~'), $enc_username);
								?>
							<div class="col-lg-13 col-md-3 arrival-grid simpleCart_shelfItem">
								<div class="grid-arr">
			...
			<!--BIVA CLASSICS-->
				<div class="new-arrivals-w3agile">
					<div class="container">
						<!--<h2 class="tittle">VALUE FOR MONEY</h2>-->
						<?php 
							$CategoryId=$this->encryption->encrypt('5');
							$CategoryId=str_replace(array('+', '/', '='), array('-', '_', '~'), $CategoryId); 

							$categoryname=$this->encryption->encrypt('BIVA CLASSICS');
							$categoryname=str_replace(array('+', '/', '='), array('-', '_', '~'), $categoryname);
						...
						<?php foreach ($homebivaclassics as $homebivaclassic): ?>
								<?php
										$this->load->library('encrypt');
										$enc_username=$this->encryption->encrypt($homebivaclassic->Product_Id);
										$enc_username=str_replace(array('+', '/', '='), array('-', '_', '~'), $enc_username);
								?>
							<div class="col-lg-13 col-md-3 arrival-grid simpleCart_shelfItem">
								<div class="grid-arr">
			...
			<!-- THRILLER & ADVENTURE -->
				<div class="new-arrivals-w3agile">
					<div class="container">
						<!--<h2 class="tittle">VALUE FOR MONEY</h2>-->
						<?php 
							$CategoryId=$this->encryption->encrypt('6');
							$CategoryId=str_replace(array('+', '/', '='), array('-', '_', '~'), $CategoryId); 

							$categoryname=$this->encryption->encrypt('THRILLER & ADVENTURE');
							$categoryname=str_replace(array('+', '/', '='), array('-', '_', '~'), $categoryname);
						...
						<?php foreach ($homethrillers as $homethriller): ?>
								<?php
										$this->load->library('encrypt');
										$enc_username=$this->encryption->encrypt($homethriller->Product_Id);
										$enc_username=str_replace(array('+', '/', '='), array('-', '_', '~'), $enc_username);
								?>
							<div class="col-lg-13 col-md-3 arrival-grid simpleCart_shelfItem">
								<div class="grid-arr">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-6 ban-bottom">
								<div class="ban-top">
								<?php 
									$CategoryId=$this->encryption->encrypt('10');
									$CategoryId=str_replace(array('+', '/', '='), array('-', '_', '~'), $CategoryId); 

									$categoryname=$this->encryption->encrypt('SCIENCE GENRE');
									$categoryname=str_replace(array('+', '/', '='), array('-', '_', '~'), $categoryname);
							...
							<div class="col-md-6 ban-bottom3">
								<div class="ban-top">
									<?php 
									$CategoryId=$this->encryption->encrypt('7');
									$CategoryId=str_replace(array('+', '/', '='), array('-', '_', '~'), $CategoryId); 

									$categoryname=$this->encryption->encrypt('POEM & VERSE');
									$categoryname=str_replace(array('+', '/', '='), array('-', '_', '~'), $categoryname);
								...
								<div class="ban-img">
									<div class=" ban-bottom1">
										<div class="ban-top">
											<?php 
												$CategoryId=$this->encryption->encrypt('8');
												$CategoryId=str_replace(array('+', '/', '='), array('-', '_', '~'), $CategoryId); 

												$categoryname=$this->encryption->encrypt('ROMANCE GENRE');
												$categoryname=str_replace(array('+', '/', '='), array('-', '_', '~'), $categoryname);
									...
									<div class="ban-bottom2">
										<div class="ban-top">
											<?php 
												$CategoryId=$this->encryption->encrypt('11');
												$CategoryId=str_replace(array('+', '/', '='), array('-', '_', '~'), $CategoryId);

												$categoryname=$this->encryption->encrypt('SOCIAL DRAMA');
												$categoryname=str_replace(array('+', '/', '='), array('-', '_', '~'), $categoryname);
						...
						<div class="row bottom-row">
							<div class="col-md-6 ban-bottom">
								<div class="ban-top">
									<?php 
										$CategoryId=$this->encryption->encrypt('12');
										$CategoryId=str_replace(array('+', '/', '='), array('-', '_', '~'), $CategoryId); 


										$categoryname=$this->encryption->encrypt('PHILOSOPHY & BELIEFS');
										$categoryname=str_replace(array('+', '/', '='), array('-', '_', '~'), $categoryname);
							...
							<div class="col-md-6 ban-bottom">
								<div class="ban-top">
									<?php 
										$CategoryId=$this->encryption->encrypt('9');
										$CategoryId=str_replace(array('+', '/', '='), array('-', '_', '~'), $CategoryId); 

										$categoryname=$this->encryption->encrypt('TEENAGE CHILD FICTIONS');
										$categoryname=str_replace(array('+', '/', '='), array('-', '_', '~'), $categoryname);
			...
			<!-- LITTLE MAGAZINE HUB -->
				<div class="new-arrivals-w3agile">
					<div class="container">
						<!--<h2 class="tittle">VALUE FOR MONEY</h2>-->
						<?php 
							$CategoryId=$this->encryption->encrypt('13');
							$CategoryId=str_replace(array('+', '/', '='), array('-', '_', '~'), $CategoryId); 

							$categoryname=$this->encryption->encrypt('LITTLE MAGAZINE HUB');
							$categoryname=str_replace(array('+', '/', '='), array('-', '_', '~'), $categoryname);
				 		?>
						<div class="col-md-12 common" style="">
						<div class="row main-cont" style="">
						...
						<div class="arrivals-grids">
							<?php foreach ($homemagazinhubs as $homemagazinhub): ?>
								<?php
										$this->load->library('encrypt');
										$enc_username=$this->encryption->encrypt($homemagazinhub->Product_Id);
										$enc_username=str_replace(array('+', '/', '='), array('-', '_', '~'), $enc_username);
								?>
							<div class="col-lg-13 col-md-3 arrival-grid simpleCart_shelfItem">
								<div class="grid-arr">
			...
			<!-- BOOKS OF OTHER PUBLISHER -->
				<div class="new-arrivals-w3agile">
					<div class="container">
						<!--<h2 class="tittle">VALUE FOR MONEY</h2>-->
						<?php 
							$CategoryId=$this->encryption->encrypt('14');
							$CategoryId=str_replace(array('+', '/', '='), array('-', '_', '~'), $CategoryId); 

							$categoryname=$this->encryption->encrypt('BOOKS OF OTHER PUBLISHER');
							$categoryname=str_replace(array('+', '/', '='), array('-', '_', '~'), $categoryname);
						...
						<div class="arrivals-grids">
							<?php foreach ($homeothers as $homeother): ?>
								<?php
										$this->load->library('encrypt');
										$enc_username=$this->encryption->encrypt($homeother->Product_Id);
										$enc_username=str_replace(array('+', '/', '='), array('-', '_', '~'), $enc_username);
								?>
							<div class="col-lg-13 col-md-3 arrival-grid simpleCart_shelfItem">
								<div class="grid-arr">
					...
					<h3 class="title">BEST SELLING BOOKS</h3> 
								<div id="logos">
								  ...
								  <?php foreach($bestselling as $bestbook): ?>
								  	<?php 
								  		$Product_Id=$this->encryption->encrypt($bestbook->Product_Id);
